use crate::{
    Authentication, Capability, ParseType, Post, SocialSource, SourceError, SourceQuirk, User,
};
...
impl SocialSource for Farcaster {
    fn definition(&self) -> crate::SourceDefinition {
        crate::SourceDefinition {
            name: "Farcaster",
            base_url: self.hub_url.clone(),
            protocol: ParseType::PublicJson,
            authentication: Authentication::None,
            capabilities: CAPABILITIES,
            quirks: &[SourceQuirk::UndocumentedPublicEndpoint],
        }
    }
